...
export default phrases(12, [
  ...
  ['mii kai', 'มีไข้', ['I have a fever', 'have a fever']],
  ['pε̂ε à-rai', 'แพ้อะไร', ['what are you allergic to']],
  ['ao yaa nɔ̀i', 'เอายาหน่อย', ['some medicine please']],
  ['hǔa jèp tâng wan', 'หัวเจ็บทั้งวัน', ['my head hurt all day']],
  ['fan jèp', 'ฟันเจ็บ', ['toothache', 'my tooth hurts']],
  ['rao bpai roong-pá-yaa-baan', 'เราไปโรงพยาบาล', ['we are going to the hospital']],
  ['pǒm rúu-sụ̀k dii kûn', 'ผมรู้สึกดีขึ้น', ['I feel better']],

...
export default scriptWords(27, [
  ...
  ['hâa#2', '๕', ['five', '5'], 'num', ['letter', 'digit', 'voice:w:hâa']],
  ['hòk#2', '๖', ['six', '6'], 'num', ['letter', 'digit', 'voice:w:hòk']],
  ['jèt', '๗', ['seven', '7'], 'num', ['letter', 'digit', 'voice:w:jèt']],
  ['bpὲεt', '๘', ['eight', '8'], 'num', ['letter', 'digit', 'voice:w:bpὲεt']],
  ['gâo', '๙', ['nine', '9'], 'num', ['letter', 'digit', 'voice:w:gâo']],
])

...
export const CONSONANTS: Consonant[] = [
  ...
  { char: 'ผ', name: 'pɔ̌ɔ pụ̂ng', cls: 'high', initial: 'p', final: '' },
  ...
  { char: 'ร', name: 'rɔɔ rụa', cls: 'low', initial: 'r', final: 'n' },
...
export const VOWELS: Sign[] = [
  ...
  { char: 'ึ', reads: 'ụ', where: 'above' },
  { char: 'ื', reads: 'ụụ', where: 'above' },
  ...
  { char: 'เ◌ือ', reads: 'ụa', where: 'around' },
  { char: '◌ัว', reads: 'ua', where: 'around' },
  { char: 'ฤ', reads: 'rụ́', where: 'alone' },
]

...
export const DEMO: DemoCard[] = [
  ...
  {
    stem: 'coffee',
    id: 'p:kɔ̌ɔ gaa-fεε yen nʉ̀ng gε̂εo',
    thai: 'ขอกาแฟเย็นหนึ่งแก้ว',
    rom: 'kɔ̌ɔ gaa-fεε yen nʉ̀ng gε̂εo',
  ...
  {
    stem: 'from',
    id: 'p:kun maa jàak bprà-têet à-rai',
    thai: 'คุณมาจากประเทศอะไร',
    rom: 'kun maa jàak bprà-têet à-rai',
    ...
    balloon: { lines: ['คุณมาจาก', 'ประเทศอะไร'], em: 5.94 },
  },
  {
    stem: 'slowly',
  ...
  },
  {
    ...
    rom: 'líao kwǎa',
    en: 'turn right',
    alt: 'Riding pillion on a motorbike taxi, a woman points right.',
    balloon: { lines: ['เลี้ยวขวา'], em: 3.94 },
  },
  {
    stem: 'stop',
    id: 'p:jɔ̀ɔt tîi nîi',
  ...
  {
    stem: 'water',
    id: 'p:kɔ̌ɔ náam bplào nʉ̀ng kùat',
    thai: 'ขอน้ำเปล่าหนึ่งขวด',
    rom: 'kɔ̌ɔ náam bplào nʉ̀ng kùat',
  ...
  {
    stem: 'stall',
    id: 'p:gǔai-dtǐao duu nâa gin',
    thai: 'ก๋วยเตี๋ยวดูน่ากิน',
    rom: 'gǔai-dtǐao duu nâa gin',
    en: 'the noodles look tasty',
    alt: 'A cook ladles noodles into a bowl at a stall while a woman waits.',
    balloon: { lines: ['ก๋วยเตี๋ยว', 'ดูน่ากิน'], em: 4.17 },
  },
  {
    stem: 'nospicy',
    id: 'p:mâi pèt',
  ...
  {
    stem: 'table',
    id: 'p:kɔ̌ɔ jɔɔng dtó sɔ̌ɔng tîi',
    thai: 'ขอจองโต๊ะสองที่',
    rom: 'kɔ̌ɔ jɔɔng dtó sɔ̌ɔng tîi',
    en: 'I would like to book a table for two people',
    alt: 'At a restaurant, a woman holds up two fingers to a waitress holding menus.',
    balloon: { lines: ['ขอจองโต๊ะ', 'สองที่'], em: 4.89 },
  },
  {
    stem: 'dinner',
    id: 'p:kun yùu tîi-nǎi',
    thai: 'คุณอยู่ที่ไหน',
    rom: 'kun yùu tîi-nǎi',
    en: 'where do you live',
    alt: 'At a round table she sits between a friend in a red shirt and an older man in a blue shirt, with soup, greens, and rice.',
    balloon: { lines: ['คุณอยู่', 'ที่ไหน'], em: 2.99 },
  },
  {
    stem: 'children',
    id: 'p:kun mii lûuk mái',
    thai: 'คุณมีลูกไหม',
    rom: 'kun mii lûuk mái',
    en: 'do you have children',
    alt: 'At a food stall an older woman sits across from her, a pot on the burner and two bowls on the low table.',
    balloon: { lines: ['คุณมีลูก', 'ไหม'], em: 3.82 },
  },
  {
    stem: 'bill',
    id: 'p:gèp dtang dûai',
  ...
  {
    stem: 'eaten',
    id: 'p:gin kâao rʉ̌ʉ yang',
    thai: 'กินข้าวหรือยัง',
    rom: 'gin kâao rʉ̌ʉ yang',
...
export const QUIET: { stem: string; alt: string }[] = [
  ...
  { stem: 'cat', alt: 'A woman crouches at a blue door and offers a bowl of rice to an orange cat.' },
  { stem: 'elder', alt: 'A woman kneels on a mat and pours tea for an older woman.' },
  { stem: 'market', alt: 'At a vegetable stall a woman takes a bunch of greens from an older seller.' },
  { stem: 'dishes', alt: 'A woman washes a plate at a kitchen sink, a rack of dishes beside her.' },
  { stem: 'sewing', alt: 'A woman works a sewing machine while an older woman holds a piece of cloth.' },
]
